		...
		<div class='memberupdatedish' >
			<el-form  :model="form"  ref="form" label-width="130px" >
				...
				<el-form-item class='required_message_hide' label=" " prop="used_other" :rules="filter_rules({required:true})">
					<span style='display: inline-block;width:128px'>与其他代金券混用</span>
					<el-radio-group v-model="form.used_other">
						<el-radio :disabled='is_find' label="1" value='1'>不可以</el-radio>
						<el-radio :disabled='is_find' label="0" value='0'>可以</el-radio>
				...
				<el-form-item class='required_message_hide' label=" "  prop="can_give_friend" :rules="filter_rules({required:true})">
					...
					<el-radio-group v-model="form.can_give_friend">
						<el-radio :disabled='is_find' label="0" value='0'>不可以</el-radio>
						<el-radio :disabled='is_find' label="1" value='1'>可以</el-radio>
					</el-radio-group>
				</el-form-item>
				<el-form-item class='required_message_hide' label=" "  prop="check_only" :rules="filter_rules({required:true})">
					...
					<el-radio-group v-model="form.check_only">
						<el-radio :disabled='is_find' label="0" value='0'>不校验</el-radio>
						<el-radio :disabled='is_find' label="1" value='1'>校验</el-radio>
				...
				<el-form-item  label="备注:" class='no-required'  prop="remark">
...
<script>
	...
	import {saveOrUpdateDishCoupon,getCouponsDetails,issueWechart,findSmsTemplate} from '@/api/coupon'
	...
	export default {
		...
		methods: {
			...
			submitForm(formName,type) {
				_czc.push(["_trackEvent", "卡券中心-电子券-代金券", "创建代金券"]);//埋点统计
           ...
           handleCheckAllChange(event) {
		    ...
		    getCouponDish(id,type){
		        ...
		        if(type=='detail'){
		         	this.is_find = true;
		         	this.coupon_title = '查看代金券'
		        }
		        else{
		        	this.is_find = false;
		        	this.coupon_title = '编辑代金券'
		        }
		    	let data = 'id='+id;
	    		this.loadingBody = true;
